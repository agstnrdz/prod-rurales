...
map.getView().fit([-7523494.497953, -5762650.542034, -7498245.878837, -5740153.795831], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Visualizador Interactivo - Productores de la Agricultura Familiar</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (1043 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'En el marco del Informe de Productores de la Agricultura Familiar, que tiene como objetivo presentar y analizar los datos relevados en el marco de la Ordenanza Municipal N° 17.192/24 que establece la consolidación de un régimen de protección y fomento para los emprendimientos productivos de la agricultura familiar de la ciudad, contribuyendo al fortalecimiento y sostenibilidad, se presenta este visualizador web interactivo de la distribución espacial de los 145 productores relevados en el período de 80 días que estuvo disponible el formulario. Elaborado el 12 de junio de 2025. El campo "producción" representa el destino principal de la producción de cada emprendimiento, codificado como: 1 para Autoconsumo, 2 para Autoconsumo y comercialización, y 3 para Comercialización. En el campo que muestra la presencia de medidor de agua, el valor 1 es positivo, el valor 2 es negativo y el valor 3 es sin datos. Por su parte, en los campos de cada actividad productiva, el valor 1 indica actividad principal y el valor 2 actividad secundaria.';
            }
