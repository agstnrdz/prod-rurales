...
map.getView().fit([-7527418.158698, -5763894.284184, -7498868.716331, -5739335.550638], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Visualizador Interactivo - Mapeo de Productores de la Agricultura Familiar</h2>';
        return titleElement;
    })(),
