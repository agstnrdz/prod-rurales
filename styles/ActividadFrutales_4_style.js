...
function categories_ActividadFrutales_4(feature, value, size, resolution, labelText,
        ...
        image: new ol.style.Circle({radius: 12.0 + size,
            displacement: [0, 0], stroke: new ol.style.Stroke({color: 'rgba(17,12,14,1.0)', lineDash: null, lineCap: 'butt', lineJoin: 'miter', width: 1.52}), fill: new ol.style.Fill({color: 'rgba(94,119,228,0.8509803921568627)'})}),
...
case 'Secundaria':
                    return [ new ol.style.Style({
        image: new ol.style.Circle({radius: 12.0 + size,
            displacement: [0, 0], stroke: new ol.style.Stroke({color: 'rgba(17,12,14,1.0)', lineDash: null, lineCap: 'butt', lineJoin: 'miter', width: 1.52}), fill: new ol.style.Fill({color: 'rgba(255,146,3,0.8509803921568627)'})}),
        text: createTextStyle(feature, resolution, labelText, labelFont,
                              labelFill, placement, bufferColor,
                              bufferWidth)
    })];
